package com.f55119018.BramGithubUsers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List of GitHub Users | F55119018");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
